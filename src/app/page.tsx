        ...
        <div className="container philosophy-container">
          <div className="philosophy-text-box">
            ...
            <p className="philosophy-p">
              At L&apos;Ambroisie, we believe dining is a sacred ritual. Every dish is a carefully composed sonnet, celebrating the absolute purity of seasonal ingredients sourced from independent artisanal producers.
            </p>
            <p className="philosophy-p">
        ...
        <div className="container testimonials-container">
          ...
          <div className="quote-box">
            <p className="testimonial-quote">
              &ldquo;L&apos;Ambroisie remains the ultimate sanctuary of haute cuisine. A masterclass in precision, balance, and pure culinary poetry.&rdquo;
            </p>
